...
public class MaiNeNNPlayer extends SPPlayer {
    int numSimulationsPerAction = 1000; // 10000 took way too long
    int playoutTerminationDepth = 4;
    MaiNeStateFeaturesLR features = new MaiNeStateFeaturesLR();
    boolean verbose = false;//true;

    public MaiNeNNPlayer() {
        super("MaiNeNNPlayer");
    }
